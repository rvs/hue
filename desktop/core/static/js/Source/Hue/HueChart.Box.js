...
HueChart.Box = new Class({
		...
		setScales: function(vis) {
				...
				var xMin = this.hasMetadata('chartStateTime') ? this.metadata.chartStartTime : this.getData(true).getMinValue(this.xProperty);
		...
		setTicks:function(vis) {
				...
				if (this.options.ticks.x) {
						...
						var chartStart = this.metadata.chartStartTime;
						var chartEnd = this.metadata.chartEndTime;
